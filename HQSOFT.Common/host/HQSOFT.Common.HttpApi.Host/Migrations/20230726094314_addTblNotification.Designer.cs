...
namespace HQSOFT.Common.Migrations
{
    ...
    [Migration("20230726094314_addTblNotification")]
    partial class addTblNotification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HQSOFT.Common.HQAssigneds.HQAssigned", b =>
                {
                    ...
                    b.ToTable("CommonHQAssigneds", (string)null);
                });

            modelBuilder.Entity("HQSOFT.Common.HQAssigneds.HQAssignedIdentityUser", b =>
                {
                    b.Property<Guid>("HQAssignedId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("IdentityUserId")
                        .HasColumnType("uuid");

                    b.HasKey("HQAssignedId", "IdentityUserId");

                    b.HasIndex("IdentityUserId");

                    b.HasIndex("HQAssignedId", "IdentityUserId");
            ...
            modelBuilder.Entity("HQSOFT.Common.HQTasks.HQTask", b =>
                {
                    ...
                    b.ToTable("CommonHQTasks", (string)null);
                });
            ...
            modelBuilder.Entity("HQSOFT.Common.HQAssigneds.HQAssignedIdentityUser", b =>
                {
                    b.HasOne("HQSOFT.Common.HQAssigneds.HQAssigned", null)
                        .WithMany("IdentityUsers")
                        .HasForeignKey("HQAssignedId")
